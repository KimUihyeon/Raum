...
<link rel="stylesheet" href="Asset/00_Css/Join-3-welcom.css">
...
<script src="Asset/00_Script/Join-3-welcom.js"></script>
<title>:: RAUM</title>
</head>
<%
	String no = request.getParameter("no");

	Query = "update Raum_Request set FinalConfirm=? where R_no="+no;
	PreparedStatement cursorHelper = con.prepareStatement(Query);
	cursorHelper.setString(1,"o");
...
<div id="wrap">
    ...
    <section id="keyContainer">
        ...
        <div class="keyContainer_text">
        	<div class="keyContainer_text1">Requisition Accept
            </div>
            <div class="keyContainer_text2">Home / 마이페이지 / 의뢰내역 / 최종승인
            </div>
        </div>
    </section>
    
    <section id="section1">
    	<div class="section1_text1">제작의뢰가 최종승인 되었습니다.
        </div>
        <div class="section1_text2">제작부터 배송까지 일주일정도 소요됩니다.
        </div>
        <div class="section1_text3">제작현황은 상담원 연결로 알수있습니다.
        </div>
    </section>
