...
<link rel="stylesheet" href="Asset/00_Css/Mypage3-product-ordering1.css?ver=2">
    ...
    <section id="section1">
    	<div class="section_Center">
            ...
            <div class="section1_box1">
                ...
                <%	
					Query = "select * from Raum_Cart , Raum_Product where Raum_Cart.Prd_no = Raum_Product.Prd_no and M_id='"+currentLogin+"' ORDER BY Cart_no desc";
            ...
            <div class="section1_box2">
                ...
                <div class="section1_box2_2">
                    ...
                    <div class="totalPrice"><%=filalPrice%>.25 천원
                    </div>
		...
		radioChk();
            ...
            <div class="section1_box5">
                ...
                <div class="boxline">
                    ...
                    <div class="paymentPrice">= &#8361 <%=filalPrice%>.25
                    </div>
                </div>
            ...
            <div class="section1_box6">
            	<div class="boxline">
                	<div class="paymentWayBox">
                    	<input type="radio" id="way0" name="paymentWay" value="card"><div class="paymentWay noRadio" disabled>신용카드</div>
                        <input type="radio" id="way1" name="paymentWay" value="bank1"><div class="paymentWay noRadio"disabled>실시간 계좌이체</div>
                        <input type="radio" id="way2" name="paymentWay" value="bank2"><div class="paymentWay noRadio"disabled>무통장 입금</div>
                        <input type="radio" id="way3" name="paymentWay" value="phone"><div class="paymentWay noRadio"disabled>휴대폰 결제</div>
