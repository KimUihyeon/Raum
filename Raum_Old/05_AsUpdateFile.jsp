...
<%
	...
	String saveDir = application.getRealPath("/RaumTest/Asset/01_img/99_UpdateAs/");
	...
	Query = "insert into Raum_AS (M_id,A_title,A_text,A_date,A_file) value(?,?,?,?,?)";
	...
	cursorHelper.setString(5,realFileName);

	cursorHelper.executeUpdate();

	response.sendRedirect("05_AS-2.jsp");
