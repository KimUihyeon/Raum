...
<div id="wrap">
    ...
    <section id="keyContainer">
        ...
        <div class="keyContainer_text">
            ...
            <div class="keyContainer_text2">Home / 고객센터 / 문의 접수완료
            </div>
        </div>
    </section>
    
    <section id="section1">
    	<div class="section1_text1">문의가 정상 등록되었습니다.
        </div>
        <div class="section1_text2">답변까지 하루에서 이틀 이상 소요될 수 있습니다.
        </div>
        <div class="section1_text3">마이페이지 > 1:1문의에서 확인하실 수 있습니다.
        </div>
    </section>
