...
<div id="wrap">
    ...
    <section id="keyContainer">
        ...
        <div class="keyContainer_text">
            ...
            <div class="keyContainer_text2">Home / 고객센터 / AS 접수완료
            </div>
        </div>
    </section>
    
    <section id="section1">
    	<div class="section1_text1">AS가 정상 접수되었습니다.
        </div>
        <div class="section1_text2">상품배송까지 최대 2-3주 소요됩니다.
        </div>
        <div class="section1_text3">고객센터 대표번호 ) 031-815-5155;
        </div>
    </section>
